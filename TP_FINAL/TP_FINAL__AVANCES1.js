...
function mouseClicked() {
  if (estado===0) {
    if (overMouse(250, 330, 200, 50)) {
      estado=1;
    }
  }
  if (estado===1) {
    if (overMouse( 250, 370, 140, 50)) {
      estado=2;
    }
  }

  if (estado===2) {
    if (overMouse( 120, 370, 140, 50)) {
      estado=3;
    }
    if (overMouse( 370, 370, 140, 50)) {
      estado=4
    }
  }
  ...
  if (estado===4) {
    if (overMouse(  250, 370, 150, 50)) {
      estado=5;
    }
  }

  if (estado===5) {
    if (overMouse( 160, 330, 320, 50)) {
      estado=6;
    }
  }

  if (estado===6) {
    if (overMouse( 70, 370, 250, 50)) {
      estado=7;
    }
    if (overMouse(330, 370, 250, 50)) {
      estado=8;
    }
  }
  ...
  if (estado===9) {
    if (overMouse(  220, 330, 200, 50)) {
      estado=10;
    }
  }

  if (estado===10) {
    if (overMouse( 330, 370, 270, 50)) {
      estado=11;
    }
    if (overMouse(70, 370, 220, 50)) {
      estado=12;
    }
  }
  ...
  if (estado===12) {
    if (overMouse( 290, 330, 340, 50)) {
      estado=14;
    }
    if (overMouse(20, 330, 260, 50)) {
      estado=13;
    }
  }
